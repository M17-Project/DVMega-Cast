...
file, You can obtain one at http://mozilla.org/MPL/2.0/.
 ...
 This file has been modified for DVMEGA-Cast by PE1MSZ (ruud@combitronics.nl) & by W0CHP (WPSD Project)
"""
    ...
    def connect(self):
        ...
        for port in self.ports:
            ...
            for speed in defaultSpeeds:
                ...
                self.ser.write(b"\xff\xff\xff\xe0\x0c\x04\xff\x00\x00\x00\x00\x00\x00\x00\x00\xff\xff\xff")
